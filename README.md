...
* navigate to the Function are about half-way down the page:

<p align='center'><img style='width: 60%;' src='docs/img/lambda-shot.png' width=500px/></p>

Copy the python code from "docs/transcribe-lambda.py" into the lambda_function code editor (replacing the stub code). Click the "Save" button towards the top-right of the Lambda tab.
